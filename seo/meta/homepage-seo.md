# Homepage Meta Optimization Config
**Target Page:** Homepage (`index.html`)

---

## 1. Meta Tag Matrix
- **Title Tag**: `Best Abroad Education Consultants in Kochi & Kerala | Globalvista` (57 characters) - High-CTR focused, localized entity authority.
- **Meta Description**: `Globalvista International LLP is the best abroad study consultancy in Kerala & Kochi. Specializing in Germany Ausbildung, free education, & student visas.` (154 characters) - action-oriented, NLP entity optimized.
- **URL Slug**: `/` (Homepage Canonical)
- **Primary Keywords**: `best agency for studying abroad in kerala`, `best education consultants in kochi`, `abroad education consultants`, `best german consultancy in kerala`

---

## 2. Social Graph Markup (JSON-LD & Open Graph Blocks)

```html
<!-- Primary Canonical -->
<link rel="canonical" href="https://www.globalvista.io/" />
